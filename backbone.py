...
def cspdarknet53(input_data):
    ...
    print('[INFO][core.backbone.cspdarknet53] Initializing cspdarknet53 backbone-architecture ')
    ...
    print('[INFO][core.backbone.cspdarknet53] cspdarknet53 backbone-architecture initialized')
